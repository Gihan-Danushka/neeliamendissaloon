    ...
    {{-- <div class = "content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        ...
        <div class = "flex flex-wrap my-5 -mx-2">
            <div class = "w-full lg:w-1/3 p-2">
                <div class = "flex items-center flex-row w-full bg-gradient-to-r dark:from-blue-900 dark:to-blue-700 from-blue-800 via-blue-700 to-blue-600 rounded-md p-3">
                    <div class = "flex text-indigo-500 dark:text-white items-center bg-white p-2 rounded-md flex-none w-8 h-8 md:w-12 md:h-12 ">
